...
<section class="flavored-tobacco"  data-analytics-category="fact">
    <div class="row">
        <div class="column text-center medium-10 small-12 medium-centered">
            <h2 class="section-title" data-analytics-visibility data-analytics-action="element visible" data-analytics-label="getthefacts-flavoredtobaccois">
                Flavored Tobacco Is:
            </h2>
        </div>
        <div class="columns text-center large-6  small-12 medium-centered text-col">
            ...
            <div class="orbit retailer-orbit" role="region" aria-label="retailers" data-orbit data-timer-delay=6000 data-pause-on-hover=true>
        ...
        <div class="columns text-center large-8  small-12 medium-centered">
...
<section class="by-the-num text-center">
    ...
    <div class="row stats-row">
        ...
        <div class="columns large-10 small-10 small-centered large-centered text-center">
            <a class="button download-fact-btn" target="_blank"
                data-analytics-click data-analytics-action="download" data-analytics-category="page-content" data-analytics-label="getthefacts-downlaodthefacts"
               href="/images/CounterBalance_Fact_Sheet.pdf"
               download="/images/CounterBalance_Fact_Sheet.pdf">
                Download the Facts
            </a>
        </div>
    </div>
...
<section class="what-retailers-doing" id="retailers-doing">
    ...
    <div class="row">
        <div class="columns text-center large-10 medium-10 small-12 medium-centered large-centered">
            <p class="retailer-text">Vermonters are taking a stand against the tobacco industry’s influence. Check out
                the quotes below to see what these Vermonters are doing to reduce tobacco’s
                impact on our state’s young people. <a href="/contact-us">Contact Us</a> to share your story.</p>
...
<section class="find-retailers"  data-analytics-category="fact">
    <div class="row">
            ...
            <div class="center-content">
                <div class="row ">
                    <div class="column small-12 medium-8 medium-offset-2">
                        ...
                        <h3 class="section-title font-32 text-center" data-analytics-visibility data-analytics-action="element visible" data-analytics-label="getthefacts-tobaccoretailers">
                            TOBACCO RETAILERS BY THE NUMBERS
                        </h3>
                        <hr/>
                        <p class="text-center">Flavored tobacco products are accessible and affordable for youth according to the 2018 Counter Tools Store Audit Report. These products are often sold in close proximity to schools in Vermont, with 29% of schools being within 1,000 feet of a tobacco retailer. This is troubling as youth are more likely to start smoking when there are more tobacco retailers in a given area.</p>

                    </div>
                </div>
                <div class="row stats-row">
                    <div class="columns large-4  small-8 small-centered">
                        <h2 class="stat-header text-center margin-bottom-1">49%</h2>
                        <p class="fact lead text-center"> Almost 50% of Vermont tobacco retail stores offer tobacco product price promotions.</p>
                    </div>
                    <div class="columns large-4 small-8 small-centered">
                        <h2 class="stat-header text-center margin-bottom-1">86%</h2>
                        <p class="fact lead text-center">Overall, 86% of Vermont tobacco retail stores sell flavored tobacco products.</p>
                    </div>
                    <div class="columns large-4 small-8 small-centered">
                        <h2 class="stat-header text-center margin-bottom-1">40%</h2>
                        <p class="fact lead text-center">E-cigarettes are sold in 40% of tobacco retail stores in Vermont.</p>
                    </div>
                </div>
            </div>
        </div>
